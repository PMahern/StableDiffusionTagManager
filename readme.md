...
Stable Diffusion Tag Manager is a stand alone application that has no prequisites to launch the application on linux and windows. However, some of it's functionality relies on other projects which have prerequisites.
